...
for cic1=1:Ciclos   %%CORRE TANTOS CICLOS COMO DESEEMOS
    ...
    for nod=1:N     %%CORRE (#NODOS/GRADO) CICLOS
        %%%%%%%%%%%%%%%%%%%DEADLINE%%%%%%%%%%%%%%%%%%%%%%%
        nodos(i,nod).buffer=actualiza_tiempos(nodos(i,nod).buffer,T_sim,dedline);
        %buf=nodos(i,nod).buffer; tamili=length(buf)
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %%%%%%%%%%%%%%%%%%%DEADLINE%%%%%%%%%%%%%%%%%%%%%%%
        %if(i>1)        
        %nodos(i-1,nod).buffer=Dead_Line(nodos(i,nod).buffer,dedline);
        %end
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if(length(nod)==1)%%COMPROBAMOS QUE SOLO HAYA UN NODO GANADOR PARA LA RANURA ELEGIDA
        ...
        %%%%%%%%%%%%%%%%%%%DEADLINE%%%%%%%%%%%%%%%%%%%%%%%
        %nodos(i,nod).buffer=Dead_Line(nodos(i,nod).buffer,dedline);   
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
