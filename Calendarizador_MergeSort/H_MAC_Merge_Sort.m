function [out1,out2,out3,out4,out5,out6] = PRIMAC(N,Lambda,Xi,W,K)
...
Ciclos=350000;                          %NUMERO DE CICLOS
...
%%para la probabilidad de paquete perdido
pkt_loss=1-(pkts_recibidos')./(pkt_status(:,1)+pkt_status(:,2));
%%%%%%%%%%%%%%Capacidad de la red%%%%%%%%%%%%%%
Tc = T*(Xi+2);
Capacidad=1/Tc;
pkts_generados_per_sec=Lambda*N*I;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
out1=througput;
out2=avg_timeratio;
